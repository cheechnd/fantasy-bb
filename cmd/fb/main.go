...
func newRootCmd() *cobra.Command {
	...
	root.AddCommand(versionCmd, doctorCmd, healthCmd, initCmd, configCmd, teamCmd, dbCmd, forecasterCmd, espnCmd, mlbCmd, pitchersCmd, pickupsCmd, lineupCmd, executeCmd)
